...
const candidateSeeds: CandidateSeed[] = [
  // 新規登録 5名
  { name: "田中 悠斗", stage: "新規登録", desiredRole: "Webエンジニア", incomeYen: 5_200_000, note: "自社開発企業を中心に希望。ポートフォリオ確認中。", updatedHoursAgo: 4 },
  { name: "石井 美月", stage: "新規登録", desiredRole: "広報", incomeYen: 4_500_000, note: "登録直後。ヒアリングシート送付済み。", updatedHoursAgo: 2 },
  { name: "西村 遥", stage: "新規登録", desiredRole: "店舗マネージャー", incomeYen: 4_600_000, note: "登録完了。希望条件のヒアリング予定。", updatedHoursAgo: 3 },
  { name: "松井 優斗", stage: "新規登録", desiredRole: "自動車設計エンジニア", incomeYen: 6_300_000, note: "登録完了。経歴を確認中。", updatedHoursAgo: 5 },
  { name: "長谷川 舞", stage: "新規登録", desiredRole: "看護師(訪問看護)", incomeYen: 4_900_000, note: "登録完了。希望条件をヒアリング予定。", updatedHoursAgo: 6 },
  // 面談 5名
  { name: "鈴木 美穂", stage: "面談", desiredRole: "人事(採用担当)", incomeYen: 4_800_000, note: "来週初回面談を実施予定。", updatedHoursAgo: 9 },
  { name: "小川 直人", stage: "面談", desiredRole: "生産管理", incomeYen: 5_800_000, note: "来週面談予定。実務年数を確認。", updatedHoursAgo: 11 },
  { name: "前田 翔", stage: "面談", desiredRole: "EC運営担当", incomeYen: 5_000_000, note: "来週面談。転職理由をヒアリング予定。", updatedHoursAgo: 14 },
  { name: "橋本 恵", stage: "面談", desiredRole: "品質保証", incomeYen: 5_600_000, note: "来週面談予定。", updatedHoursAgo: 13 },
  { name: "福田 拓也", stage: "面談", desiredRole: "介護施設 施設長候補", incomeYen: 5_500_000, note: "来週面談予定。", updatedHoursAgo: 12 },
  // 企業提案 4名
  { name: "加藤 拓海", stage: "企業提案", desiredRole: "プロダクトマネージャー", incomeYen: 7_500_000, note: "IT企業2社へ提案準備中。", updatedHoursAgo: 15 },
  { name: "森田 千尋", stage: "企業提案", desiredRole: "品質管理", incomeYen: 5_200_000, note: "食品メーカー2社へ提案準備中。", updatedHoursAgo: 18 },
  { name: "藤原 麻衣", stage: "企業提案", desiredRole: "バイヤー", incomeYen: 5_300_000, note: "小売2社へ提案中、反応良好。", updatedHoursAgo: 19 },
  { name: "竹内 亮太", stage: "企業提案", desiredRole: "生産技術", incomeYen: 6_100_000, note: "自動車部品メーカーへ提案準備中。", updatedHoursAgo: 21 },
  // 面接 5名
  { name: "渡部 蓮", stage: "面接", desiredRole: "法人営業(SaaS)", incomeYen: 6_000_000, note: "来週最終面接。給与交渉のポイントを整理中。", updatedHoursAgo: 26 },
  { name: "村上 由紀", stage: "面接", desiredRole: "生産技術", incomeYen: 5_700_000, note: "来週最終面接。逆質問リストを準備中。", updatedHoursAgo: 8 },
  { name: "岩崎 健太郎", stage: "面接", desiredRole: "エリアマネージャー", incomeYen: 6_800_000, note: "来週最終面接。対策を実施中。", updatedHoursAgo: 10 },
  { name: "川口 直樹", stage: "面接", desiredRole: "工程管理", incomeYen: 6_700_000, note: "来週最終面接。", updatedHoursAgo: 17 },
  { name: "秋山 健", stage: "面接", desiredRole: "薬剤師", incomeYen: 6_500_000, note: "一次面接を通過。最終面接の日程調整中。", updatedHoursAgo: 20 },
  // 内定 3名
  { name: "山田 花子", stage: "内定", desiredRole: "マーケティング担当", incomeYen: 6_500_000, note: "内定連絡受領。返答期限は今週末。", updatedHoursAgo: 5 },
  { name: "三浦 大和", stage: "内定", desiredRole: "工場長候補", incomeYen: 8_200_000, note: "内定獲得。年収交渉が最終段階。", updatedHoursAgo: 6 },
  { name: "平野 沙織", stage: "内定", desiredRole: "購買", incomeYen: 5_200_000, note: "内定連絡受領。承諾検討中。", updatedHoursAgo: 27 },
  // 承諾 3名
  { name: "高橋 大輝", stage: "承諾", desiredRole: "バックエンドエンジニア", incomeYen: 7_000_000, note: "内定承諾済み。入社日を調整中。", updatedHoursAgo: 12 },
  { name: "木下 彩", stage: "承諾", desiredRole: "販売促進", incomeYen: 5_400_000, note: "内定承諾済み。前職の引き継ぎ調整中。", updatedHoursAgo: 16 },
  { name: "原田 由美", stage: "承諾", desiredRole: "理学療法士", incomeYen: 5_000_000, note: "内定承諾済み。入社書類を準備中。", updatedHoursAgo: 20 },
  // 入社 2名
  { name: "中島 陽菜", stage: "入社", desiredRole: "カスタマーサクセス", incomeYen: 5_500_000, note: "入社1週目。オンボーディング順調との報告あり。", updatedHoursAgo: 30 },
  { name: "大野 悠", stage: "入社", desiredRole: "店舗開発", incomeYen: 6_000_000, note: "入社2週目。実績資料の引き継ぎも完了。", updatedHoursAgo: 24 },
  // 辞退 3名
  { name: "岡田 健一", stage: "辞退", desiredRole: "経営企画", incomeYen: 8_000_000, note: "選考中に他社内定を承諾されクローズ。", updatedHoursAgo: 40 },
  { name: "佐野 涼", stage: "辞退", desiredRole: "機械設計エンジニア", incomeYen: 6_200_000, note: "条件面で折り合わずクローズ。", updatedHoursAgo: 22 },
  { name: "伊藤 さくら", stage: "辞退", desiredRole: "経理(会計事務所)", incomeYen: 5_000_000, note: "転職活動自体を一時中断されクローズ。", updatedHoursAgo: 25 },
];
