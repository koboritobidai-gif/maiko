...
const LABELS: Record<"sheets" | "slack" | "marketing", Record<SourceStatus, string>> = {
  sheets: {
    live: "Sheets(連携中)",
    demo: "Sheets(デモ)",
...
export function sourceBadgeLabel(kind: "sheets" | "slack" | "marketing", status: SourceStatus): string {
